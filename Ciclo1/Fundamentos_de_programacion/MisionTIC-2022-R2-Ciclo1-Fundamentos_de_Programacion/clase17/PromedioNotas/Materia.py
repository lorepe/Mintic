...
class Materia:    
    ...
    def __init__(self,nota1=None,nota2=None,nota3=None,nota4=None,nota5=None,nombre=None,creditos=None,docenteEncargado=None):
        ...
        self.__docenteEncargado = docenteEncargado 
    ...
    def mostrarInfoMateria(self):
        ...
        print('Profesor: ', self.__docenteEncargado.getNombre())

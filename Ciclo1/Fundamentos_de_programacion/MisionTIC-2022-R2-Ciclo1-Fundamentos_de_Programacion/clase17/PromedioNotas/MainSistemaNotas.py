...
##Crear profesor
profesor1=Profesor(nombre="Jose Faset")

#Instanciar: crear los objetos tipo nota
objetoMateria = Materia(nota1=objetoNota1, nota2=objetoNota2, nota3=objetoNota3, nota4=objetoNota4, nota5=objetoNota5,nombre="Estructura de Lenguajes", creditos=3,docenteEncargado=profesor1)
